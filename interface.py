...
from generated_graph import graph, distances, stations  # Importujemy dane z wygenerowanego grafu
...
def run_interface():
    ...
    def run_optimization():
        ...
        best_route, best_score = aco.optimize(start_node="N3", end_node="N19")
